...
@Component({
  ...
  template: `
    <aem-container [attr.data-cq-page-path]="path" [cqPath]="path" [cqItems]="items" [cqItemsOrder]="itemsOrder"></aem-container>
  `
})
...
export class AppComponent {
  ...
  constructor(private modelManagerService: ModelManagerService,
    ...
    if (platform) {
      ...
      if (rootModel) {
        modelStore = new ModelStore(rootModel[Constants.PATH_PROP], rootModel);
      }
