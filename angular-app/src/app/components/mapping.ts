...
MapTo('weretail/components/content/text')(TextComponent, TextEditConfig);
MapTo('weretail/components/content/image')(ImageComponent, ImageEditConfig);
MapTo('wcm/foundation/components/responsivegrid')(AEMResponsiveGridComponent);
MapTo('we-retail-journal/global/components/weather')(WeatherComponent);
MapTo('weretail/components/structure/navigation')(NavigationComponent);
