...
public class GetPreRenderedPageBody extends SlingSafeMethodsServlet {
     ...
     */
    private String getRootModel(SlingHttpServletRequest request) throws JsonProcessingException {
        ...
        return mapper.writeValueAsString( page.getRootModel() );
    }
